const notificationMessages = {
  ...
  project: {
      ...
      applicationExpired: (projectTitle) => `**Đơn ứng tuyển của bạn cho "${projectTitle}"** đã hết hạn. Đừng nản chí, còn nhiều cơ hội tuyệt vời đang chờ đón bạn!`,
      applicationRejected: (projectTitle) => `**Rất tiếc,** lần này chúng tôi chưa thể hợp tác cùng bạn trong dự án **"${projectTitle}"**. Hãy tiếp tục phát triển và thử sức với những cơ hội mới nhé!`,
